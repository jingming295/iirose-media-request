...
export class NeteaseApi
{
    ...
    async getNeteaseMusicDetail(id: number)
    {
        ...
        try
        {
            ...
            const MusicDetail: MusicDetail = await response.json() as MusicDetail;
            return MusicDetail;
        } catch (error)
        {
    ...
    async getSongResource(id: number)
    {
        ...
        try
        {
            ...
            return await response.json() as songResource[];
        } catch (error)
        {
    ...
    async getAlbumSimpleDetail(id: number)
    {
        ...
        try
        {
            ...
            const albumData: Album = await response.json() as Album;
            return albumData;
        } catch (error)
        {
    ...
    async getSonglistDetail(id: number)
    {
        ...
        try
        {
            ...
            const songListData: SongList = await response.json() as SongList;
            return songListData;
        } catch (error)
        {
            console.error(error);
